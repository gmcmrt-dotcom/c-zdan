...
const LOYALTY_TIERS = [
  ...
  [1, "rookie", "Rookie Plus", 0, 0, "0", "0", "1", "0"],
  [2, "rookie", "Rookie Pro", 1, 50, "1000", "0", "1.02", "0"],
  [3, "rookie", "Rookie Prime", 2, 150, "3000", "0", "1.05", "0"],
  [4, "silver", "Silver Plus", 0, 400, "10000", "0", "1.08", "0"],
  [5, "silver", "Silver Pro", 1, 700, "25000", "0", "1.10", "0"],
  [6, "silver", "Silver Prime", 2, 1_000, "50000", "0", "1.12", "0"],
  [7, "gold", "Gold Plus", 0, 2_500, "100000", "1", "1.18", "0"],
  [8, "gold", "Gold Pro", 1, 4_000, "250000", "1", "1.22", "0"],
  [9, "gold", "Gold Prime", 2, 5_000, "500000", "1", "1.25", "0"],
  [10, "platinum", "Platinum Plus", 0, 15_000, "750000", "2", "1.32", "0"],
  [11, "platinum", "Platinum Pro", 1, 20_000, "1500000", "2", "1.40", "0"],
  [12, "platinum", "Platinum Prime", 2, 25_000, "2000000", "2", "1.50", "0"],
  [13, "diamond", "Diamond Plus", 0, 60_000, "4000000", "3", "1.58", "0"],
  [14, "diamond", "Diamond Pro", 1, 80_000, "7000000", "3", "1.66", "0"],
  [15, "diamond", "Diamond Prime", 2, 100_000, "10000000", "3", "1.75", "0"],
  [16, "elite", "Elite Plus", 0, 300_000, "20000000", "5", "1.85", "0"],
  [17, "elite", "Elite Pro", 1, 400_000, "35000000", "5", "1.92", "0"],
  [18, "elite", "Elite Prime", 2, 500_000, "50000000", "5", "2.00", "0"],
] as const;
...
async function seedSettings() {
  const defaults: Array<{ key: string; value: unknown; description: string }> = [
    ...
    // OTP
    { key: "otp_length", value: 6, description: "OTP digit count" },
    { key: "otp_ttl_minutes", value: 10, description: "OTP validity window (minutes)" },
    { key: "otp_max_attempts", value: 5, description: "Max OTP verification attempts" },
    { key: "otp_resend_seconds", value: 60, description: "Cooldown before OTP resend (seconds)" },
    // Loyalty (K2 — admin BO /admin/settings)
    { key: "first_topup_bonus", value: 50, description: "One-time first topup bonus points (legacy)" },
    { key: "first_topup_bonus_v2", value: 50, description: "One-time first topup bonus points (v2)" },
    { key: "monthly_active_threshold", value: 3, description: "Min tx count for monthly-active bonus" },
    { key: "monthly_active_bonus", value: 25, description: "Monthly active user bonus points" },
    { key: "monthly_active_bonus_v2", value: 25, description: "Monthly active user bonus points (v2)" },
    { key: "birthday_bonus_points", value: 100, description: "Birthday bonus points" },
    { key: "profile_complete_bonus", value: 25, description: "Profile completion bonus (phone added)" },
    { key: "points_per_topup_unit", value: 100, description: "TL per 1 topup point (legacy key)" },
    { key: "points_per_topup_unit_v2", value: 100, description: "TL per 1 topup point (v2)" },
    { key: "points_per_spend_unit", value: 10, description: "TL per spend point base unit" },
    { key: "points_per_spend_unit_v2", value: 10, description: "TL per spend point base unit (v2)" },
    { key: "withdraw_penalty_per_unit", value: 10, description: "TL per withdraw penalty unit" },
    { key: "turnover_bonus_log_base", value: 2, description: "log2 base for turnover bonus multiplier" },
    { key: "payment_code_lengths", value: [15, 60, 1440], description: "Payment code TTL options (minutes)" },
  ];
